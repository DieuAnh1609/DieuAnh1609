<%@page import="adminmodal.adminxacnhan"%>
...
<body>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="text-center " style="font-weight: bold;">Quản Lý Đơn Hàng</h1>
                    </div>
                </div>
            </div>
        </section>
	...
	<form method='post' action='QLDHController'>

		<table class="table table-bordered " style="background-color: white; margin-top: 20px">
 				<thead>
	 				<% ArrayList<adminxacnhan> ds1 = (ArrayList<adminxacnhan>)request.getAttribute("ds");
					if(ds1.size() > 0)
					{%>
			            <tr>
			         	   <th width="450px">Họ tên khách hàng</th>
			         	    <th width="250px">Ngày mua</th>
			         	        <th width="350px">Số lượng mua</th>
			         	           <th width="100px" >Giá</th>
			         	    <th width="250px">Thành tiền</th>
			                <th width="300px">Mã Hóa Đơn</th>
			  				<th colspan="1" width="500px" class="text-center">Xác nhận đơn hàng</th>
			  				<th colspan="1" width="500px" class="text-center">Hủy đơn hàng</th>
			            </tr>
			         <%} %>
		        </thead>
			<% ArrayList<adminxacnhan> ds2 = (ArrayList<adminxacnhan>)request.getAttribute("ds");
				for(adminxacnhan xn:ds2)
			{%>
				<tr>
					...
					<td><a href = "QLDHController?mct=<%=xn.getMaHoaDon()%>" class = "btn btn-success btn-white">Xác Nhận</a> 
					
				
					
					<td>
						<a href="QLDHController?mctxoa=<%=xn.getMaHoaDon()%>" class = "btn btn-danger btn-white">Hủy</a>
					</td>
