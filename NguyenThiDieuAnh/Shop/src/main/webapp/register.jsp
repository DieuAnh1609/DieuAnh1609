...
<div class="form-container">
  <h2>Đăng Ký</h2>
  <form class="form-signup" action="registerController" method="post">
    ...
    <button class="btn-custom" type="submit" name="dk">Đăng Ký</button>
  </form>
  <% String ms = (String)request.getAttribute("message"); 
    if( ms != null){
      out.print("<div class='message'>" + ms + "</div>");
    }
  %>
</div>
